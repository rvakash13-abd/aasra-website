...
// A single WebGL canvas, fixed behind the whole page, so the animated
// shader is visible on every section as the user scrolls — not just
// inside the hero viewport.
